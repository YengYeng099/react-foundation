    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a
                href="#"
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-700 hover:border-indigo-500 hover:text-indigo-400"
              >
                <svg className="h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
              ...
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-700 hover:border-indigo-500 hover:text-indigo-400"
              >
                <svg className="h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-gray-800 pt-6 sm:flex-row">
          ...
          <p className="text-sm">Made with ❤️ by ISHOP.</p>
        </div>
      </div>
    </footer>
  );
