...

{
  ...
  const [deleteProductRequest, { data: deleteProductReponse }] =
    useDeleteProductByUuidMutation();
  async function delProduct(uuid) {
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <aside className="sticky top-6">
            ...
            <div className="mt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  onClick={() => {
                    dispatch(increment());
                    dispatch(addToCart({ uuid,thumbnail, title, price, description }));
                  }}
                >
                  🛒 Add to Cart
                </button>
          ...
          <div className="mt-6 bg-white rounded-xl p-4 shadow-sm">
            ...
            <div
              id="detailsPanel"
              className="mt-3 hidden text-sm text-gray-600"
            >
