...
export default function RegisterComponent() {
  ...
  const formSchema = z.object({
    ...
    password : z.string("AT least 6 letters")
  ...
  const HandleRegisterSubmit = async (data) =>{
    const userRegisterRequest = {
      ...
      profile: "https://i.pinimg.com/736x/46/12/5f/46125f78d9efe0fe7f96fc71c6f70670.jpg",
    };
    try {
      ...
      <div className="w-full flex items-center justify-center">
        <div className="w-3/4 max-w-md p-8 bg-white shadow-lg rounded-lg">
          ...
          <button className="w-full mt-4 border border-gray-300 py-2 rounded-lg flex items-center justify-center hover:bg-gray-100 transition">
            <img
              src="https://i.pinimg.com/originals/69/63/30/6963300430027e72e36b4a4d5082eed5.gif"
              alt="Google"
